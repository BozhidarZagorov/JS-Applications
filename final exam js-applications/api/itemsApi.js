...
export const endpointLikes = {
    getItemLikes: (itemId) => `${bonusUrl}/data/useful?where=characterId%3D%22${itemId}%22&distinct=_ownerId&count`,
    hasUserLikedItem: (itemId, userId) => `${bonusUrl}/data/useful?where=characterId%3D%22${itemId}%22%20and%20_ownerId%3D%22${userId}%22&count`,
    likeItem: `${bonusUrl}/data/useful`,
};
